...
namespace vies
{
    ...
    public interface checkVatPortType
    {
        ...
        vies.checkVatResponse checkVat(vies.checkVatRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<vies.checkVatResponse> checkVatAsync(vies.checkVatRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        vies.checkVatApproxResponse checkVatApprox(vies.checkVatApproxRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<vies.checkVatApproxResponse> checkVatApproxAsync(vies.checkVatApproxRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface checkVatPortTypeChannel : vies.checkVatPortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class checkVatPortTypeClient : System.ServiceModel.ClientBase<vies.checkVatPortType>, vies.checkVatPortType
    {
        ...
        vies.checkVatResponse vies.checkVatPortType.checkVat(vies.checkVatRequest request)
        {
        ...
        {
            vies.checkVatRequest inValue = new vies.checkVatRequest();
            inValue.countryCode = countryCode;
            inValue.vatNumber = vatNumber;
            vies.checkVatResponse retVal = ((vies.checkVatPortType)(this)).checkVat(inValue);
        ...
        public System.Threading.Tasks.Task<vies.checkVatResponse> checkVatAsync(vies.checkVatRequest request)
        {
            return base.Channel.checkVatAsync(request);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        vies.checkVatApproxResponse vies.checkVatPortType.checkVatApprox(vies.checkVatApproxRequest request)
        {
        ...
        public System.DateTime checkVatApprox(
                    ...
                    out vies.matchCode traderNameMatch, 
                    out vies.matchCode traderCompanyTypeMatch, 
                    out vies.matchCode traderStreetMatch, 
                    out vies.matchCode traderPostcodeMatch, 
                    out vies.matchCode traderCityMatch, 
                    out string requestIdentifier)
        {
            vies.checkVatApproxRequest inValue = new vies.checkVatApproxRequest();
            inValue.countryCode = countryCode;
            inValue.vatNumber = vatNumber;
            ...
            vies.checkVatApproxResponse retVal = ((vies.checkVatPortType)(this)).checkVatApprox(inValue);
            countryCode = retVal.countryCode;
            vatNumber = retVal.vatNumber;
            valid = retVal.valid;
